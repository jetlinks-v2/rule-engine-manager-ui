...
.multi-trigger-card__product { flex: 0 0 var(--scene-linkage-resource-select-width, 18rem); width: var(--scene-linkage-resource-select-width, 18rem) !important; min-width: var(--scene-linkage-resource-select-width, 18rem); }.multi-trigger-card__scope { flex: 0 0 var(--scene-linkage-device-select-width, 18rem); width: var(--scene-linkage-device-select-width, 18rem); min-width: var(--scene-linkage-device-select-width, 18rem); }.multi-trigger-card__thing { flex: 0 0 var(--scene-linkage-thing-model-select-width, 18rem); width: var(--scene-linkage-thing-model-select-width, 18rem) !important; min-width: var(--scene-linkage-thing-model-select-width, 18rem); }.multi-trigger-card__output { flex: 0 0 var(--scene-linkage-thing-model-select-width, 18rem); width: var(--scene-linkage-thing-model-select-width, 18rem) !important; min-width: var(--scene-linkage-thing-model-select-width, 18rem); }.multi-trigger-card__term { width: var(--scene-linkage-compact-select-width, 8rem); }.multi-trigger-card__value { width: var(--scene-linkage-value-input-width, 11rem); }.multi-trigger-card__repeat-options { display: grid; gap: var(--space-3, 12px); padding: var(--space-3, 12px); padding-right: 3rem; background: var(--ant-color-fill-quaternary); border-radius: 6px; }.multi-trigger-card :deep(.alarm-trigger-row__target-select) { flex: 0 0 var(--scene-linkage-resource-select-width, 18rem) !important; width: var(--scene-linkage-resource-select-width, 18rem) !important; min-width: var(--scene-linkage-resource-select-width, 18rem); }.multi-trigger-card :deep(.alarm-trigger-row__product) { flex: 0 0 var(--scene-linkage-resource-select-width, 18rem); width: var(--scene-linkage-resource-select-width, 18rem) !important; min-width: var(--scene-linkage-resource-select-width, 18rem); }.multi-trigger-card :deep(.alarm-trigger-row__alarm-config) { flex-basis: calc(100% - 3rem); }.multi-trigger-card__row :deep(.device-state-trigger) { flex: 1 1 auto; }.multi-trigger-card__remove { position: absolute; right: var(--space-3, 12px); bottom: var(--space-3, 12px); padding: 0; color: #ff4d4f !important; }.multi-trigger-card__remove :deep(.anticon) { color: #ff4d4f !important; }
</style>
